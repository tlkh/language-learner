  ...
  return (
    <div className="page character-page">
      ...
      <section className="character-reference" aria-labelledby="character-reference-title">
        <div className="section-heading"><div><h2 id="character-reference-title">Reference chart</h2><p>Browse the complete pack-authored inventory before practicing.</p></div></div>
