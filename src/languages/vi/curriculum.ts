...
export const collections: LearningCollection[] = [
  ...
  },
  {
    ...
    description: "Land, orient yourself, and move confidently around Vietnam.",
...
export const priorityOverrides: Record<string, "must-know" | "useful" | "reference"> = {
  ...
  "cảm ơn": "must-know",
  "xin lỗi": "must-know",
  "giúp tôi với": "must-know",
  "nhà vệ sinh": "must-know",
  "bệnh viện": "must-know",
  "dị ứng": "must-know",
  "không cay": "must-know",
  "bao nhiêu tiền": "must-know",
  "địa chỉ này": "must-know",
  "taxi": "useful",
  "Wi-Fi": "useful",
  "sạc điện thoại": "useful"
};
